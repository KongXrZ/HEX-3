   ...
   <div className="flex justify-center items-center mt-[80px]">
     ...
     <div className="flex flex-col items-start gap-[30px]">
      <div className="flex gap-[120px] items-center">
        <div data-aos="fade-up" className="text-black w-[700px] flex flex-col gap-[30px] px-10 py-10 rounded-xl bg-white/10 backdrop-blur-sm ">
        ...
        <div data-aos="fade-up" className="border-2 border-black w-[400px] h-[300px] rounded-2xl"></div>
      </div>
      <Link href="/started" data-aos="fade-up" className="bg-[#00BF63] p-[15px] flex items-center justify-center w-[150px] text-2xl font-black rounded-[15px]">Start</Link>
    </div>
   </div>
  );
}
